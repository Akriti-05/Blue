package com.techster.aashaapp.Adapters;
...
import com.techster.aashaapp.chatDetailActivity;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.viewHolder> {
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.sample_show_uaer, parent, false);
